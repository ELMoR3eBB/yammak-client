...
import AdjustModal from "./Modals/AdjustModal.jsx";
          ...
          <>
                      ...
                      options={{
                        ...
                        plugins: {
                          legend: {
                            position: "top",
                            labels: {
                              color: isLightTheme ? "rgba(51, 65, 85, 0.9)" : "rgba(255, 255, 255, 0.82)",
                            },
                          },
                        ...
                        scales: {
                          x: {
                            ...
                            ticks: {
                              maxRotation: 45,
                              font: { size: 11 },
                              color: isLightTheme ? "rgba(51, 65, 85, 0.9)" : "rgba(255, 255, 255, 0.72)",
                            },
                          },
                          y: {
                            beginAtZero: true,
            ...
            {items.length === 0 ? (
              <div className="storageEmpty">
                <img src={getAssetUrl("assets/undraw/no_storage.png")} alt="" draggable={false} className="StorageEmptyStateIllustration" />
                <p>{t("storage.empty")}</p>
                {canManage && (
